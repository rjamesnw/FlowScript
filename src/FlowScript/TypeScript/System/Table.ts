...
namespace FlowScript {
    ...
    export class Column {
        ...
        get type(): NamespaceObject { return this._type; }
        private _type: NamespaceObject;
    ...
    /** Represents a structure of data, much like a class.
      ...
      * flagged as readonly, 
      */
    export class Table extends NamespaceObject {
        // --------------------------------------------------------------------------------------------------------------------
        ...
        constructor(parent: NamespaceObject, tableName: string) {
