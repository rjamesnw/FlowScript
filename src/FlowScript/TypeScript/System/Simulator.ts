...
namespace FlowScript {
    ...
    export class Simulator {
        ...
        hasComponentRenderer(typeOrComp: any): boolean {
            return this._mainRenderer.hasRenderer(typeof typeOrComp == 'string' ? typeOrComp : (<NamespaceObject>typeOrComp).safeFullTypeName);
        }
        ...
        getComponentRenderer(typeOrComp: any): TypeRenderer {
            return this._mainRenderer.getRenderer(typeof typeOrComp == 'string' ? typeOrComp : (<NamespaceObject>typeOrComp).safeFullTypeName);
        }
