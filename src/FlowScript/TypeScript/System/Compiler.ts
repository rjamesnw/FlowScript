...
namespace FlowScript {
    ...
    export class TypeRenderer {
        ...
        get type(): NamespaceObject { return this._source; }
        private _source: NamespaceObject;
        ...
        constructor(compiler: Compiler, source: NamespaceObject, isSimulation?: boolean);
        constructor(parent: TypeRenderer, source: NamespaceObject, isSimulation?: boolean);
        constructor(compilerOrParent: any, source: NamespaceObject, isSimulation = false) {
        ...
        static createRootTypeRenderer(compiler: Compiler, isSimulation = false): TypeRenderer {
            return new TypeRenderer(compiler, new NamespaceObject(null, "root", compiler.script), isSimulation);
        }

        private _checkType(type: NamespaceObject): void {
        ...
        registerType(type: NamespaceObject): TypeRenderer {
            this._checkType(type);

            var types: NamespaceObject[] = [], root = this.root, rend: TypeRenderer = root;
    ...
    export class Compiler {
        ...
        _renderOp(renderedLValue: string, operationType: NamespaceObject, renderedRValue: string): string;
        ...
        _renderOp(renderedLValue: string, operationTypeName: any, renderedRValue: string): string {
            if (typeof operationTypeName == 'object' && operationTypeName instanceof NamespaceObject)
                operationTypeName = (<NamespaceObject>operationTypeName).fullTypeName;
