@echo off 
REM The following is an auto-generated list of extensions used by this project. 
REM Exported on: 2018-10-14 23:13:03.85 
call code --install-extension alefragnani.project-manager 
call code --install-extension bajdzis.vscode-database 
...
call code --install-extension dbalage.vscode-stylesheet-formatter 
...
call code --install-extension GregorBiswanger.json2ts 
call code --install-extension hbenl.vscode-firefox-debug 
call code --install-extension HookyQR.beautify 
call code --install-extension howardzuo.vscode-git-tags 
call code --install-extension jasonlhy.vscode-browser-sync 
call code --install-extension jchannon.csharpextensions 
call code --install-extension jmrog.vscode-nuget-package-manager 
call code --install-extension josephwoodward.vscodeilviewer 
call code --install-extension ms-vscode.csharp 
call code --install-extension ms-vscode.mono-debug 
call code --install-extension ms-vscode.PowerShell 
call code --install-extension ms-vscode.typescript-javascript-grammar 
call code --install-extension ms-vscode.vs-keybindings 
call code --install-extension msjsdiag.debugger-for-chrome 
call code --install-extension msjsdiag.debugger-for-edge 
call code --install-extension pmneo.tsimporter 
call code --install-extension salbert.comment-ts 
