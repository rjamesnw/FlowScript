    ...
    <IComponents>{
        "System": {
            ...
            types: {
                ...
                "Boolean": { title: "Boolean($?value)", componentType: ComponentTypes.Unary, returnType: "Boolean", tip: "Represents a boolean (true/false) type." },
                "String": { title: "String($?value)", componentType: ComponentTypes.Unary, returnType: "String", tip: "Represents a string of characters." },
                /*
