...
namespace FlowScript.Core {
    ...
    export class FSObject extends Component {
        ...
        constructor(parent: Type, superType?: FSObject, title: string = "Object($?value)") {
    ...
    export class CodeBlock extends Type { // (a block of script)
        constructor(parent: Type) {
    ...
    export class FunctionalComponent extends Type {
        constructor(parent: Type) {
    ...
    export class ExpressionList extends Type { // (eg: '(x=1,y=x, z=y)')
        constructor(parent: Type) {
    ...
    export class Operator extends Component {
        private _typeMapping: { result: Type; ifTypes: Type[] }[] = [];
