...
namespace FlowScript {
    ...
    */
    export class Component extends Type implements IReferencedObject {
        // --------------------------------------------------------------------------------------------------------------------
        ...
        protected _instanceType: Type; // (if set, this represents the type expected as the "$this" in custom code expressions for this component [example: the 'with' component will have this set to 'System.Object'])
        ...
        /** Defines a new local variable to use as a return value for this component.
          ...
          */
        defineReturnVar(name: string, returnType: Type = System.Any): Property {
        ...
        /** Defines a default return value for this functional component.
          ...
          * expression executed.
          */
        defineDefaultReturnVar(returnType: Type = System.Any): Property { return this.defineReturnVar(null, returnType); }
