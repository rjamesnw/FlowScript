...
declare class TestClass {
    /**
     * someMethod 1st def
     * @param stringParameter comments for string parameter
     */
     ...
     * more ... more ...
     * more ...
     * @param numberParameter comments for number parameter
     * @param stringParameter comments for this string param
     */
     ...
     */
    aMethod(stringParameter: string): void;
     ...
     * @param stringParameter
     */
    aMethod(numberParameter: number, stringParameter: string): void;
